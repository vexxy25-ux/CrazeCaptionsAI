...
const dataMap = {
  auto:{ subjects:["dark romance","AI side hustles","creator growth hacks","psychological horror","glow up routines","faceless TikTok"] },
  booktok:{ subjects:["dark romance","enemies to lovers","morally grey men","booktok drama","spicy booktok reads"] },
  horror:{ subjects:["psychological horror","disturbing stories","analog horror","creepy storytime","unsettling fiction"] },
  ai:{ subjects:["AI side hustles","passive income with AI","faceless TikTok automation","AI money methods","digital product sales"] },
  glowup:{ subjects:["glow up routines","that girl productivity","self improvement arc","morning routine reset","confidence glow up"] },
  creator:{ subjects:["TikTok growth secrets","content creator tips","algorithm hacks","viral posting strategy","creator monetization"] }
};
